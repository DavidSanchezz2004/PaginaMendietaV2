              ...
              <table class="module-table" style="width:100%; border-collapse:collapse;">
                ...
                <tbody>
                  @forelse($purchases as $purchase)
                    @php
                      $tipoMap = ['01'=>'Factura','03'=>'Boleta','07'=>'N.Crédito','08'=>'N.Débito','00'=>'DUA'];
                    ...
                    <tr style="border-bottom:1px solid var(--clr-border-light,#f3f4f6);">
                      <td style="padding:.75rem 1rem; font-size:.85rem;">
                        <span style="font-weight:700; padding:.2rem .5rem; background:rgba(0,0,0,.04); border-radius:5px;">{{ $tipoMap[$purchase->codigo_tipo_documento] ?? $purchase->codigo_tipo_documento }}</span>
                      </td>
