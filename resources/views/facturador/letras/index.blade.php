...
@push('styles')
  ...
  <style>
    ...
    .stat-card { background:var(--clr-bg-card,#fff); border:1px solid var(--clr-border-light,rgba(0,0,0,.06)); border-radius:14px; padding:1.1rem 1.25rem; display:flex; flex-direction:column; gap:.25rem; box-shadow:0 4px 15px rgba(0,0,0,.03); }
    ...
    .filter-bar input, .filter-bar select { padding:.55rem .85rem; border:1px solid var(--clr-border-light,#e5e7eb); border-radius:8px; font-size:.9rem; color:var(--clr-text-main,#111827); background:transparent; outline:none; font-family:inherit; }
    .badge-pendiente  { background:rgba(245,158,11,.1); color:#d97706; border:1px solid rgba(245,158,11,.25); }
    .badge-cobrado    { background:rgba(16,185,129,.1); color:#059669; border:1px solid rgba(16,185,129,.25); }
    .badge-protestado { background:rgba(239,68,68,.1);  color:#dc2626; border:1px solid rgba(239,68,68,.25); }
    .badge-vencida    { background:rgba(239,68,68,.1);  color:#dc2626; border:1px solid rgba(239,68,68,.25); }
    .letra-badge { display:inline-flex; align-items:center; gap:.3rem; padding:.25rem .65rem; border-radius:12px; font-size:.72rem; font-weight:700; white-space:nowrap; }
    .progress-bar-wrap { background:#f3f4f6; border-radius:4px; height:6px; margin-top:4px; }
    .progress-bar-fill { background:#3b82f6; border-radius:4px; height:6px; transition:width .3s; }
  </style>
@endpush
