...
use App\Policies\GuiaRemisionPolicy;
use App\Policies\InvoicePolicy;
use App\Policies\LetraPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(LetraCambio::class, LetraPolicy::class);
        Gate::policy(GuiaRemision::class, GuiaRemisionPolicy::class);
    }
}
